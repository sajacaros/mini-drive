/** 인라인 SVG 아이콘 (Lucide 스타일, 신규 의존성 없이). currentColor 를 상속한다. */
...
export const DriveIcon = (p: IconProps) => (
  <svg {...base(p)}>
    <path d="M22 12H2M5.5 5h13l3 7-3 7h-13l-3-7 3-7Z" />
  </svg>
);
...
/** 즐겨찾기 — 별. filled 면 채워서(활성), 아니면 외곽선(비활성). */
